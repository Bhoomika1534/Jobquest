                ...
                <div
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
                        <div> 
                            ...
                            Are you ready to take the next step in your career journey? Look no further! Our premier job portal connects talented individuals like you with exciting opportunities across various industries.                            </p>
                            ...
                            <div>
                                ...
                                <nav aria-label="Footer Navigation - Company" className="mt-6">
                                    <ul className="space-y-4 text-sm">
                                        ...
                                        <li>
                                            <a href="/accreview" className="text-gray-700 transition hover:opacity-75">
                                                Accounts Review
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <div>
                                ...
                                <nav aria-label="Footer Navigation - Legal" className="mt-6">
                                    <ul className="space-y-4 text-sm">
                                        ...
                                        <li>
                                            <a href="/statistic" className="text-gray-700 transition hover:opacity-75">
                                                Hiring Statistics
                                            </a>
                                        </li>
                                    </ul>
