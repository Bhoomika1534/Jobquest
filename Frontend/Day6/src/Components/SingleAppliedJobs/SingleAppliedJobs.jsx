...
const SingleAppliedJobs = ({ singleJob, onDelete }) => {
    const { id, company_logo, company_name, job_title, remote_or_onsite, location, salary } = singleJob;
        ...
        <div className='md:flex w-80 md:w-3/5 mx-auto border-2 rounded-3xl justify-between items-center p-4 bg-slate-200 mb-4'>
            <div className='md:flex gap-4 items-center'>
                <div className="image p-2">
                    <img src={company_logo} className='w-36' alt={company_name} />
                </div>
            ...
            <div>
                <button onClick={handleDelete} className='custom-btn mt-4 w-full'>
                    Delete Job
                </button>
